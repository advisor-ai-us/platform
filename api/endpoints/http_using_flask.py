...
from plugins.portfolio_performance.utils import handle_incoming_user_message_to_portfolio_performance
...
def chat_incoming_message():
    ...
    if advisorPersonalityName == 'dashboard':
        ...
        response = handle_incoming_user_message_to_portfolio_performance(userEmail, message)

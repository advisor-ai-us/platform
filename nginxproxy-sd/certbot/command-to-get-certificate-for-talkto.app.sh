...
#certbot certonly --webroot --webroot-path=/var/www/html/ --agree-tos --no-eff-email --email tanmoy@grmtech.com --rsa-key-size 4096 -d www.talkto.app -d talkto.app
...
cp /etc/letsencrypt/live/www.talkto.app/fullchain.pem /gt/gt-prog-repos/platform/nginxproxy-sd/https-certificates/talkto.app/
cp /etc/letsencrypt/live/www.talkto.app/privkey.pem   /gt/gt-prog-repos/platform/nginxproxy-sd/https-certificates/talkto.app/
